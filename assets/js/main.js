...
const levelOne = ["https://res.cloudinary.com/ktm28/image/upload/v1588621832/Jungle_book/SherKhan.png", "https://res.cloudinary.com/ktm28/image/upload/v1588621832/Jungle_book/Mowguli.png", "https://res.cloudinary.com/ktm28/image/upload/v1588621831/Jungle_book/King_Louis.png", "https://res.cloudinary.com/ktm28/image/upload/v1588621831/Jungle_book/baloo.png"];
const levelTwo = ["https://res.cloudinary.com/ktm28/image/upload/v1588621831/Jungle_book/Bagheera.png", "https://res.cloudinary.com/ktm28/image/upload/v1588621831/Jungle_book/Kaa.png"];
const levelThree = ["https://res.cloudinary.com/ktm28/image/upload/c_scale,h_150,w_150/v1588621832/Jungle_book/Winifred.png", "https://res.cloudinary.com/ktm28/image/upload/v1588621831/Jungle_book/Akela.png"]; 
...
class MemoryGame {
  ...
  generateCards() {
    const level = this.currentLevel; // ES6 spread operator method Duplicates cards for each levels

    let duplicate = [...levels[level], ...levels[level]];
    let insertCard = document.querySelector('.card-container');
    duplicate.forEach(href => insertCard.innerHTML += `<div class="card"><div class="card-back card-face">
